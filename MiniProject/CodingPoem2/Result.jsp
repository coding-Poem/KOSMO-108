...
<html>
	...
	<hr>
<% 
	//CodingPoem.jsp에서 보낸 aList 데이터 받아오기
	ArrayList<String> aList = null;
	aList = new ArrayList<String>();
	
	aList = (ArrayList<String>)request.getAttribute("aList");
	if(aList!=null && aList.size()>0){
		String p1 = aList.get(0);
		String p2 = aList.get(1);
		String p3 = aList.get(2);
		String p4 = aList.get(3);
		String p5 = aList.get(4);
		String p6 = aList.get(5);
		...
		ArrayList<Integer> _aList = cp.wrappingNumber(lo);
		
		//사람뽑기함수 담을 VO준비하고 담기(_aList에 랜덤번호, cpvo에 게임에 참여한 사람, 함수는 그 두개를 묶는 역할)
		CodingPoemVO _cpvo = null;
		_cpvo = new CodingPoemVO();
		_cpvo = cp.pickPerson(_aList, cpvo);
		System.out.println("-------------------------------------------");
