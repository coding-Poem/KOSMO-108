...
public abstract class ChabunQuery {
	...
	public static final short CHABUN_QUERY_M = 1;
...
//			String sql = ChabunQuery.chabun_query[ChabunQuery.CHABUN_QUERY_T6];
	...
	public static String getMemChabunQuery() {
		System.out.println("2222 :: ChabunQuery.getMemChabunQuery() >>> : ");
		...
		try {
			...
			String sql = ChabunQuery.chabun_query[CHABUN_QUERY_M];
			pstmt = conn.prepareStatement(sql);
			System.out.println("채번 쿼리 >>> : \n" + sql);
			...
			if (rsRs !=null) { 
				...
				System.out.println("ChabunQuery :: getMemChabunQuery() :: commNum >>> : "+commNum);
			}else {
				System.out.println("ChabunQuery :: 채번 검색 결과가 없넹 ㅋㅋㅋ >>> : " + rsRs);
			}
		}catch(Exception e) {
